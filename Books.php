...
class Books{
   ...
   function  getLengthOrCount(){
    ...
    /**
     * You can change the storage location(default storage)
     * @param $name
     * @param mixed ...$extensions
     */
   function uploadFile($name, ...$extensions)
   {
               ...
               if(in_array($extension, $ext)){
                   ...
                   if($size_file <= 3200000){
                       ...
                       if(move_uploaded_file($tmp_name, $storage) == TRUE){
                           ...
                           $msg = "The file has been downloaded successfully";
     ...
     * @return object
     */
   function dateFr(int $nday = 0):object{
   ...
   static function form($text, $email){

       $out = <<<__END
        
        <form method="post" action="" name="form1" id="form1">
          <input type="text" name="user" id="user" size="60" value="" $text/><br/><br/>
          <input type="email" name="email" id="email" size="60" value="" $email/><br/><br/>
